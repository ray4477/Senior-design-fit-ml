...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_MTU, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52811_WEARABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF52811_WEARABLE_NRF52811, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF52811, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF52811_QFAA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BMI270_BUS_I2C, 1);
